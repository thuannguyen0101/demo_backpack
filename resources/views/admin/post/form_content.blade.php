  ...
  <div class="card">
    <div class="card-body row">
      @include('crud::inc.show_fields', ['fields' => $crud->fields()])
         <div class="form-group col-sm-12" style="padding-right: 15px;padding-left: 15px;">
             <input type="file" name="media" id="show-upload" class="form-control" accept="image/*,video/*" style="margin: 10px 0px;display:none">
             <input type="text" name="media_url" id="show-url" class="form-control" placeholder="URL" style="margin: 10px 0px;display:none">
         </div>
