...
@section('header')
    <div class="container-fluid">
        ...
        <ul class="list-unstyled multi-steps">
            <li>{{ trans('title.systems') }}</li>
            <li>{{ trans('title.functions') }}</li>
            <li class="is-active">{{ trans('title.sub_functions') }}</li>
...
@section('content')
    ...
    <div class="modal-footer" style="place-content: center;">
        <a type="button" href="{{ route('/project/{projectId}/systems/requirements.index',$project->id) }}"
           class="btn btn-secondary" data-dismiss="modal">{{ trans('title.back') }}</a>
        <a href="{{ route('final',$project->id) }}" class="btn btn-primary">{{ trans('title.next') }}</a>
    </div>
@endsection
